...
// Rotator2
struct Rotator2_t4967EBF78DF50CE3BC95E183CE42E5F6FE8BFE13;
// System.String
struct String_t;
// TMPro.TMP_Character
...
{
	{
		...
		bool L_0;
		L_0 = Input_GetKeyDown_m0D59B7EBC3A782C9FBBF107FBCD4B72B38D993B3(((int32_t)119), NULL);
		if (!L_0)
		{
			goto IL_001b;
		}
	}
	{
		// movementY += 1;
		float L_1 = __this->___movementY_8;
		__this->___movementY_8 = ((float)il2cpp_codegen_add(L_1, (1.0f)));
	}
...
IL_001b:
	...
	{
		// movementX -= 1;
		float L_3 = __this->___movementX_7;
		__this->___movementX_7 = ((float)il2cpp_codegen_subtract(L_3, (1.0f)));
	}
...
IL_0036:
	...
	{
		// movementY -= 1;
		float L_5 = __this->___movementY_8;
		__this->___movementY_8 = ((float)il2cpp_codegen_subtract(L_5, (1.0f)));
	}
...
IL_0051:
	{
		...
		bool L_6;
		L_6 = Input_GetKeyDown_m0D59B7EBC3A782C9FBBF107FBCD4B72B38D993B3(((int32_t)100), NULL);
		if (!L_6)
		{
			goto IL_006c;
		}
	...
	{
		// movementX += 1;
		float L_7 = __this->___movementX_7;
		__this->___movementX_7 = ((float)il2cpp_codegen_add(L_7, (1.0f)));
	}
...
IL_006c:
	...
	}
	{
		...
		L_11 = Vector3_op_Multiply_m516FE285F5342F922C6EB3FCB33197E9017FF484_inline(L_10, (3.0f), NULL);
		Transform_Translate_m4A9E3D8836586E7562F6A18EBF5F5B6089D8B649(L_9, L_11, 0, NULL);
	}
...
#pragma clang diagnostic ignored "-Wunused-variable"
#endif
// System.Void Rotator2::Update()
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void Rotator2_Update_m1B01EDF44C8248E285ACD5BBBB323E61C3D0BDE8 (Rotator2_t4967EBF78DF50CE3BC95E183CE42E5F6FE8BFE13* __this, const RuntimeMethod* method) 
{
	static bool s_Il2CppMethodInitialized;
	if (!s_Il2CppMethodInitialized)
	{
	...
	float V_1 = 0.0f;
	{
		...
		float L_5 = V_1;
		float L_6 = V_0;
		Transform_Rotate_m7EA47AD57F43D478CCB0523D179950EE49CDA3E2(L_4, L_5, L_6, (0.0f), NULL);
		// }
		return;
	}
}
// System.Void Rotator2::.ctor()
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void Rotator2__ctor_mB5258AD0E622280DD234B63F31843F34C8E143A5 (Rotator2_t4967EBF78DF50CE3BC95E183CE42E5F6FE8BFE13* __this, const RuntimeMethod* method) 
{
	{
